...
{
    public class BuildingRecipeScript : MonoBehaviour, IPointerClickHandler
    {
        /*public UnityEvent<BuildingRecipeScript> OnClickEvent;
        public BuildingRecipeData recipeData;
